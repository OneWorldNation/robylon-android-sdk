...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "OWN_CONFIG_BASE_URL_PROD", "\"${Deps.OWN_CONFIG_BASE_URL_PROD}\"")
        buildConfigField("String", "OWN_CONFIG_BASE_URL_STAGE", "\"${Deps.OWN_CONFIG_BASE_URL_STAGE}\"")
        buildConfigField("String", "OWN_SDK_VERSION_CODE", "\"${Deps.SDK_VERSION_CODE}\"")
        buildConfigField("String", "OWN_SDK_VERSION_NAME", "\"${Deps.SDK_VERSION_NAME}\"")
        buildConfigField("String", "OWN_SDK_TYPE", "\"${Deps.BUILD_TYPE.name}\"")
